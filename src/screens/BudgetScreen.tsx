      ...
      <div className="p-5 flex-1 overflow-y-auto">
        ...
        <div className="bg-[#6C4CF1] rounded-[32px] p-6 text-white shadow-[0_12px_24px_rgb(108,76,241,0.25)] relative overflow-hidden mb-6">
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-3xl font-extrabold mb-6">₹1,50,000</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="h-2 bg-indigo-900/50 rounded-full overflow-hidden">
                  <div className="h-full bg-emerald-400 w-[45%] rounded-full"></div>
                </div>
              </div>
              <div>
                <div className="flex justify-between text-[11px] font-bold mb-2">
        ...
        <div className="space-y-4">
          {[
            { label: 'मूर्ति (Idol)', allocated: 50000, spent: 30000, color: 'bg-orange-500', bg: 'bg-orange-100' },
            { label: 'सजावट (Decor)', allocated: 40000, spent: 15000, color: 'bg-pink-500', bg: 'bg-pink-100' },
            { label: 'साउंड (Sound)', allocated: 20000, spent: 10000, color: 'bg-blue-500', bg: 'bg-blue-100' },
            { label: 'प्रसाद (Prasad)', allocated: 30000, spent: 8000, color: 'bg-emerald-500', bg: 'bg-emerald-100' },
          ].map((item, i) => (
            <div key={i} className="bg-white p-4 rounded-3xl shadow-[0_4px_15px_rgb(0,0,0,0.02)] border border-slate-50">
              <div className="flex justify-between items-end mb-3">
                ...
                <span className="text-[11px] font-bold text-slate-400">₹{item.spent} / ₹{item.allocated}</span>
              </div>
