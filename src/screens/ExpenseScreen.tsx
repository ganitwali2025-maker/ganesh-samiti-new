...
export function ExpenseScreen() {
  ...
  return (
    <div className="flex flex-col h-full bg-[#FFF8F1]">
      ...
      {/* Floating Add Button */}
      <button className="fixed bottom-[100px] right-5 w-14 h-14 bg-rose-500 rounded-[20px] flex items-center justify-center text-white shadow-[0_8px_20px_rgb(244,63,94,0.4)] active:scale-95 transition-transform z-[40]">
